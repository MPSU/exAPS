> LAST UPDATE:
>
> [Лабораторная работа 3](Labs/03.%20Register%20file%20and%20memory/README.md) "Регистровый файл и память"
>
> [Лабораторная работа 4](Labs/04.%20Primitive%20programmable%20device/README.md) "Примитивное программируемое устройство"
>
> [RV32I](Other/RV32I.md) - Стандартный набор целочисленных инструкций RISC-V
>
> В настоящей статье появился раздел [#Оглавление](#)
...
- [#Практические материалы](#практические-материалы)
