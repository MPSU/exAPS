> LAST UPDATE:
>
> [Лабораторная работа 3](Labs/3.%20Register%20file%20and%20memory/README.md) "Регистровый файл и память"
>
> [Лабораторная работа 4](Labs/4.%20Primitive%20programmable%20device/README.md) "Примитивное программируемое устройство"
>
...
Столкнулся с проблемой при работе в Vivado или с кодом на Verilog и не знаешь что делать? Проверь документ "[Частых проблем](https://github.com/MPSU/APS/blob/technical/Other/FAQ.md)".  
...
Список работ направления подготовки ПИН [в квадратных скобках указаны номера лекций, в которых поднимаются соответствующие темы]:
...
3. [RF](Labs/3.%20Register%20file%20and%20memory/README.md) (Регистровый файл и память) – [Лекция 5]
4. [PPD](Labs/4.%20Primitive%20programmable%20device/README.md) (Простейшее программируемое устройство) – [Лекция 5]
5. [MD](Labs/5.%20Main%20decoder/README.md) (Основной дешифратор команд) – [Лекция 8]
6. [DP](Labs/6.%20Datapath/README.md) (Тракт данных) – [Лекции 6-8]
