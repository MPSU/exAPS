...
1. [ALU](./1.%20Arithmetic-logic%20unit/README.md) (Арифметико-логическое устройство) – [Лекции 3]
2. [RF](./2.%20Register%20file%20and%20memory/README.md) (Регистровый файл и память) – [Лекция 5]
3. [MD](./3.%20Main%20decoder/README.md) (Основной дешифратор команд) – [Лекция 8]
4. [DP](./4.%20Datapath/README.md) (Тракт данных) – [Лекции 6–8]
5. [LSU](./5.%20Load-store%20unit/README.md) (Блок загрузки и сохранения) – [Лекция 19]
6. [IS](./6.%20Interrupt%20subsystem/README.md) (Подсистема прерывания) – [Лекция 15]
