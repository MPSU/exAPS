...
3. [RF](./3.%20Register%20file%20and%20memory/README.md) (Регистровый файл и память) – [Лекция 4]
4. [PPD](./4.%20Primitive%20programmable%20device/README.md) (Простейшее программируемое устройство) – [Лекция 4]
5. [MD](./5.%20Main%20decoder/README.md) (Основной дешифратор команд) – [Лекция 7]
6. [DP](./6.%20Datapath/README.md) (Тракт данных) – [Лекции 5-7]
