...
В отличие от реализованного ранее процессора с архитектурой Cybercobra, в данной микроархитектуре используется пять различных видов констант (соответствующих определенным типам инструкций).
...
Кроме того, у программного счетчика появился управляющий сигнал `stall_i`. Программный счетчик может меняться только когда этот сигнал равен нулю (иными словами, инверсия этого сигнала является сигналом `enable` для регистра `PC`).

![../../../technical/Labs/Pic/lab_06_dp/fig_02.drawio.png](../../../technical/Labs/Pic/lab_06_dp/fig_02.drawio.png)
...
![../../../technical/Labs/Pic/lab_06_dp/fig_02.excel.png](../../../technical/Labs/Pic/lab_06_dp/fig_02.excel.png)
