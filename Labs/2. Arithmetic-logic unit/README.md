...
3. Ознакомиться с [`инструкцией по подключению Verilog Header`](../../Other/Vivado%20Basics/Verilog%20Header.md).
4. Внимательно ознакомиться с заданием (раздел [#задание](#задание))
5. В уже созданном проекте создать новый модуль для АЛУ (пример создания проекта и модулей в [`Создание базового проекта с прошивкой ПЛИС в Vivado`](../../Other/Vivado%20Basics/Vivado-trainer.md))
