...
4. Вставьте содержимое файла `tb_fulladder.v`, расположеного рядом с данным документом.
...
11. Вставьте содержимое файла `tb_fulladder32.v`, расположеного рядом с данным документом.
