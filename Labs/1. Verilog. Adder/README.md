...
6. В `Simulation Sources` проекта добавьте `Verilog`-файлы `tb_dulladder` и `tb_dulladder32` и проверьте с их помощью работу ваших модулей. При возникновении ошибок симуляции воспользуйтесь [`инструкцией по работе с ошибками симуляции`](../../Other/Simulation%20Vfailed.md)