...
![Пример склейки](../../../technical/Labs/Pic/reg_memory_read_concatenation_ex.drawio.png)
...
![Пример склейки](../../../technical/Labs/Pic/reg_memory_write_concatenation_ex.drawio.png)
...
На языке Verilog необходимо реализовать модуль регистрового файла (`rf_r𝚒sсv`) для процессора с архитектурой RISC-V, представляющего собой трехпортовую ОЗУ с двумя портами на чтение и одним портом на запись и состоящей из 32-х 32-битных регистров с именем `RAM`.
