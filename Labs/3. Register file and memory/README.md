...
2. Реализуйте память инструкций. Для этого:
   ...
   2. Опишите в нем модуль памяти инструкций с таким же именем и портами, как указано в задании.
      ...
      2. [`Добавить файл с содержимым памяти в проект`](../../Other/Vivado%20Basics/How%20to%20add%20a%20mem-file.md) и отметить [`данный файл`](program.txt) в качестве инициализирующего памяти с помощью системной функции для файла, описывающего содержимое памяти 16-ричными цифрами.
