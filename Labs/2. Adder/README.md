# Лабораторная работа 2 "Сумматор"

[`Список лабораторных`](../README.md) [`СОДЕРЖАНИЕ`](../../README.md)

## Цель

Продолжить знакомство с САПР Vivado и с помощью конструкций языка Verilog разработать одноразрядный и многоразрядный сумматор.

## Ход работы

1. Изучение, реализация и проверка полного однобитного сумматора;
2. Реализация полного четырехбитного сумматора;
3. Реализация 32-битного сумматора;
4. Проверка работы устройства на стенде.
 
## Теория
...
![](../../../technical/Labs/Pic/1_fig-4.png)
