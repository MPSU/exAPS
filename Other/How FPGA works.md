...
![mux_scheme_out_b](../../technical/Other/Pic/FPGA_mux6in1_onehot_output.drawio.png)
...
2. Операция однобитного сложения
3. Запись данных в D-триггер
4. Комбинационная схема, с записью результата в D-триггер
5. Операция однобитного сложения с записью результата в D-триггер
6. Комбинационная схема с последующей операцией однобитного сложения
7. Комбинационная схема с последующей записью однобитного сложения и записью в D-триггер
